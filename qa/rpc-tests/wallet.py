...
#   c) node1 mines 32 blocks, so now node 0 has 60001base, node 1 has 4250base, node2 has none.
#   d) node0 sends 601 base to node2, in two transactions (301 base, then 300 base).
