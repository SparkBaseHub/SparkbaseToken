...
This means one can have an always-on sparkd instance running, and another local sparkd/spark-qt instance which connects to this node and receives blocks from it.
