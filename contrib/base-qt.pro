...
RESOURCES += src/qt/base.qrc src/qt/base_locale.qrc

TRANSLATIONS += src/qt/locale/base_bg.ts \
                src/qt/locale/base_de.ts \
                src/qt/locale/base_en.ts \
                src/qt/locale/base_es.ts \
                src/qt/locale/base_fi.ts \
                src/qt/locale/base_fr.ts \
                src/qt/locale/base_it.ts \
                src/qt/locale/base_ja.ts \
                src/qt/locale/base_pl.ts \
                src/qt/locale/base_pt.ts \
                src/qt/locale/base_ru.ts \
                src/qt/locale/base_sk.ts \
                src/qt/locale/base_sv.ts \
                src/qt/locale/base_vi.ts \
                src/qt/locale/base_zh_CN.ts \
                src/qt/locale/base_zh_TW.ts
