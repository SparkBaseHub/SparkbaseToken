...
RESOURCES += src/qt/spark.qrc src/qt/spark_locale.qrc

TRANSLATIONS += src/qt/locale/spark_bg.ts \
                src/qt/locale/spark_de.ts \
                src/qt/locale/spark_en.ts \
                src/qt/locale/spark_es.ts \
                src/qt/locale/spark_fi.ts \
                src/qt/locale/spark_fr.ts \
                src/qt/locale/spark_it.ts \
                src/qt/locale/spark_ja.ts \
                src/qt/locale/spark_pl.ts \
                src/qt/locale/spark_pt.ts \
                src/qt/locale/spark_ru.ts \
                src/qt/locale/spark_sk.ts \
                src/qt/locale/spark_sv.ts \
                src/qt/locale/spark_vi.ts \
                src/qt/locale/spark_zh_CN.ts \
                src/qt/locale/spark_zh_TW.ts
