...
# Copyright (c) 2020-2021 Sparkbase AG
...
class FullBlockTest(SparkTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure sparkd isn't accepting b26
        ...
        # Extend the b28 chain to make sure sparkd isn't accepting b28
        ...
        # Spark: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the spark code has custom code which does so);
