...
class BudgetProposalTest(SparkTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid Spark address")
        assert_raises_rpc_error(-5, "Invalid Spark address", self.nodes[0].preparebudget,
