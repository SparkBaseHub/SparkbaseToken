#!/usr/bin/env python3
# Copyright (c) 2021 The Spark Core developers
...
class DIP3Test(SparkTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "invalid Spark address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid Spark address InvalidPayee", controller.protx_update_registrar,
