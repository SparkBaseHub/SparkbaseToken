...
By default, sparkd will dump mempool on shutdown and
...
class MempoolPersistTest(SparkTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent sparkd from writing mempool.dat to disk. Verify that `savemempool` fails")
