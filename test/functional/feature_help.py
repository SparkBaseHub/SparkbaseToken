...
"""Verify that starting spark with -h works as expected."""
...
class HelpTest(SparkTestFramework):
    ...
    def run_test(self):
        self.log.info("Start spark with -? for help text")
        ...
        self.log.info("Start spark with -version for version information")
