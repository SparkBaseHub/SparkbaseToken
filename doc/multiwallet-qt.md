...
In order to support loading of multiple wallets in base-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is base.cpp.
...
Changes to base.cpp
----------------------
base.cpp is the entry point into base-qt, and as such, will require some minor modifications to provide hooks for
