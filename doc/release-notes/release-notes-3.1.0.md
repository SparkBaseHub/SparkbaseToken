SparkBase version *3.1.0* is now available from:  <https://github.com/base-project/base/releases>
...
SparkBase v3.1.0 is a mandatory update for all users. This release contains new consensus rules and improvements that are not backwards compatible with older versions. Users will have a grace period of one week to update their clients before enforcement of this update is enabled.
...
### GUI
 ...
 - #467 `7099831bd` [Qt] Clear PrivacyDialog "zBase Selected" labels after sending. (presstab)
