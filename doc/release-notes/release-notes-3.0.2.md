SparkBase version 3.0.2 is now available from:
...
SparkBase v3.0.2 is a recommended, semi-mandatory update for all users. This release contains transaction creation bug fixes for zBASE spends, automint calculation adjustments, and other various updates/fixes.
...
- #292 `feadab4` Additional checks for double spending of zBase serials. (presstab)
...
- #280 `fdc182d` [Wallet] Fix zBase spending errors. (presstab)
- #282 `310f216` [Wallet] Count pending zBase balance for automint. (presstab)
...
- #291 `cb314e6` [Qt] zBase control quantity/amount fixes (rejectedpromise)
