...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1639418952, 1730726, 504365040, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        if (true && genesis.GetHash() != uint256S("0x00000b026f8d789e7c7e60b0a19f385204295d40b4fa0975822e09c6e4bfa914"))
        {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000b026f8d789e7c7e60b0a19f385204295d40b4fa0975822e09c6e4bfa914"));
        ...
        consensus.height_last_ZC_AccumCheckpoint = 200;
        consensus.height_last_ZC_WrappedSerials = 200;
        ...
        consensus.ZC_HeightStart = 200;
        consensus.ZC_TimeStart = 1545066000+(consensus.ZC_HeightStart*60);
...
*/
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "sparksks";
...
public:
    CTestNetParams()
    {
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "sparksktestsapling";
