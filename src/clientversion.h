...
#error Client version information missing: version is not defined by spark-config.h or in any other way
#endif
...
/**
 * sparkd-res.rc includes this file, but it cannot cope with real c++ code.
