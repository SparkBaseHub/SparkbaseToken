...
#ifndef SPARK_WALLET_H
#define SPARK_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_SPARK = 61000, // inherited version..
...
public:
     ...
     * SPARK: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 5000 SPARKS output and keys which can be used for the Masternode
