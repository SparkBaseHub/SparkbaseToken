...
#define MASTERNODE_AMOUNT 5000
#define MASTERNODE_AMOUNT2 4999.99
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 5000 BASE, signature to prove
