 ...
 *  A CTxDestination is the internal data type encoded in a Sparkbase Token address
 */
...
/**
 * Generate a Sparkbase scriptPubKey for the given CTxDestination. Returns a P2PKH
