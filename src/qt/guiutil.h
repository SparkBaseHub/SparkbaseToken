...
/** Utility functions used by the Sparkbase Qt UI.
 */
namespace GUIUtil
{
...
// Render Sparkbase Token addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZsparks = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZsparks = false);
...
// Parse "spark:" URI into recipient object, return true on successful parsing
