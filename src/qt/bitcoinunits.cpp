...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case SPARKS:
        return QString("spark");
    case mSPARKS:
        return QString("mspark");
    case uSPARKS:
        return QString::fromUtf8("uspark");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZsparks)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSPARKS)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZSPARKS);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSPARKS)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZSPARKS));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
