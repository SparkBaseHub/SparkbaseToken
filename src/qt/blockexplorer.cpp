...
{
    std::string genesisblockhash = "0000025257de26888da19a24038d1a58c81639136e7cf92307518f17220138e1";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            ...
            QMessageBox::warning(this, "SparkBase Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#727272;}\n a, span { font-family: monospace; }\n span.addr {color:#727272; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #727272;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#727272;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#727272;}\n";
