...
/* Sparkbase GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SPARKBASE"
#define QAPP_ORG_DOMAIN "sparkbase.io"
#define QAPP_APP_NAME_DEFAULT "SPARK-Qt"
#define QAPP_APP_NAME_TESTNET "SPARK-Qt-testnet"
