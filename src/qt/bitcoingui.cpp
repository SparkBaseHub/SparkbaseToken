                                                                            ...
                                                                            spinnerFrame(0)
{
  QApplication::setAttribute(Qt::AA_EnableHighDpiScaling);
    ...
    QString windowTitle = tr("SparkBase") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SparkBase"), this);
    aboutAction->setStatusTip(tr("Show information about SparkBase"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SparkBase help message to get a list with possible BASE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SparkBase client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("SparkBase"); // default title
