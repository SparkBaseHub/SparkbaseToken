...
#include "qt/spark/defaultdialog.h"
...
const QString SPARKGUI::DEFAULT_WALLET = "~Default";

SPARKGUI::SPARKGUI(const NetworkStyle* networkStyle, QWidget* parent) :
        QMainWindow(parent),
        clientModel(0){
...
void SPARKGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    connect(toggleHideAction, &QAction::triggered, this, &SPARKGUI::toggleHidden);
...
void SPARKGUI::connectActions()
{
    ...
    connect(topBar, &TopBar::showHide, this, &SPARKGUI::showHide);
    connect(topBar, &TopBar::themeChanged, this, &SPARKGUI::changeTheme);
    connect(topBar, &TopBar::onShowHideColdStakingChanged, navMenu, &NavMenuWidget::onShowHideColdStakingChanged);
    connect(settingsWidget, &SettingsWidget::showHide, this, &SPARKGUI::showHide);
    connect(sendWidget, &SendWidget::showHide, this, &SPARKGUI::showHide);
    connect(receiveWidget, &ReceiveWidget::showHide, this, &SPARKGUI::showHide);
    connect(addressesWidget, &AddressesWidget::showHide, this, &SPARKGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::showHide, this, &SPARKGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::execDialog, this, &SPARKGUI::execDialog);
    connect(coldStakingWidget, &ColdStakingWidget::showHide, this, &SPARKGUI::showHide);
    connect(coldStakingWidget, &ColdStakingWidget::execDialog, this, &SPARKGUI::execDialog);
    connect(settingsWidget, &SettingsWidget::execDialog, this, &SPARKGUI::execDialog);
}


void SPARKGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
#ifndef Q_OS_MAC
...
void SPARKGUI::handleRestart(QStringList args)
{
...
void SPARKGUI::setClientModel(ClientModel* _clientModel)
{
    ...
    if (this->clientModel) {
        ...
        connect(clientModel, &ClientModel::message, this, &SPARKGUI::message);
...
void SPARKGUI::createTrayIconMenu()
{
#ifndef Q_OS_MAC
    ...
    connect(trayIcon, &QSystemTrayIcon::activated, this, &SPARKGUI::trayIconActivated);
#else
    // Note: On macOS, the Dock icon is used to provide the tray's functionality.
    MacDockIconHandler* dockIconHandler = MacDockIconHandler::instance();
    connect(dockIconHandler, &MacDockIconHandler::dockIconClicked, this, &SPARKGUI::macosDockIconActivated);
...
#ifndef Q_OS_MAC
void SPARKGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
#else
void SPARKGUI::macosDockIconActivated()
 {
     show();
     activateWindow();
 }
...
void SPARKGUI::changeEvent(QEvent* e)
{
    ...
    if (e->type() == QEvent::WindowStateChange) {
        if (clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray()) {
            ...
            if (!(wsevt->oldState() & Qt::WindowMinimized) && isMinimized()) {
                QTimer::singleShot(0, this, &SPARKGUI::hide);
                e->ignore();
            } else if ((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized()) {
                QTimer::singleShot(0, this, &SPARKGUI::show);
                e->ignore();
            }
        }
    }
...
void SPARKGUI::closeEvent(QCloseEvent* event)
{
#ifndef Q_OS_MAC // Ignored on Mac
...
void SPARKGUI::messageInfo(const QString& text)
{
...
void SPARKGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret)
{
...
bool SPARKGUI::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn)
{
...
void SPARKGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if (!clientModel)
        return;
...
void SPARKGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void SPARKGUI::detectShutdown()
{
    if (ShutdownRequested()) {
        if (rpcConsole)
            rpcConsole->hide();
...
void SPARKGUI::goToSend()
{
    showTop(sendWidget);
}

void SPARKGUI::goToAddresses()
{
    showTop(addressesWidget);
}

void SPARKGUI::goToMasterNodes()
{
    showTop(masterNodesWidget);
}

void SPARKGUI::goToColdStaking()
{
    showTop(coldStakingWidget);
}

void SPARKGUI::goToSettings(){
    showTop(settingsWidget);
}

void SPARKGUI::goToSettingsInfo()
{
    navMenu->selectSettings();
...
void SPARKGUI::goToReceive()
{
    showTop(receiveWidget);
}

void SPARKGUI::openNetworkMonitor()
{
    settingsWidget->openNetworkMonitor();
}

void SPARKGUI::showTop(QWidget* view)
{
...
void SPARKGUI::changeTheme(bool isLightTheme)
{
...
void SPARKGUI::resizeEvent(QResizeEvent* event)
{
    // Parent..
...
bool SPARKGUI::execDialog(QDialog *dialog, int xDiv, int yDiv)
{
    return openDialogWithOpaqueBackgroundY(dialog, this);
}

void SPARKGUI::showHide(bool show)
{
...
int SPARKGUI::getNavWidth()
{
    return this->navMenu->width();
}

void SPARKGUI::openFAQ(SettingsFaqWidget::Section section)
{
    showHide(true);
...
#ifdef ENABLE_WALLET
bool SPARKGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    // Connect actions..
    connect(walletModel, &WalletModel::message, this, &SPARKGUI::message);
    connect(masterNodesWidget, &MasterNodesWidget::message, this, &SPARKGUI::message);
    connect(coldStakingWidget, &ColdStakingWidget::message, this, &SPARKGUI::message);
    connect(topBar, &TopBar::message, this, &SPARKGUI::message);
    connect(sendWidget, &SendWidget::message,this, &SPARKGUI::message);
    connect(receiveWidget, &ReceiveWidget::message,this, &SPARKGUI::message);
    connect(addressesWidget, &AddressesWidget::message,this, &SPARKGUI::message);
    connect(settingsWidget, &SettingsWidget::message, this, &SPARKGUI::message);

    // Pass through transaction notifications
    connect(dashboard, &DashboardWidget::incomingTransaction, this, &SPARKGUI::incomingTransaction);

    return true;
}

bool SPARKGUI::setCurrentWallet(const QString& name)
{
    // Single wallet supported.
    return true;
}

void SPARKGUI::removeAllWallets()
{
    // Single wallet supported.
}

void SPARKGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address)
{
...
static bool ThreadSafeMessageBox(SPARKGUI* gui, const std::string& message, const std::string& caption, unsigned int style)
{
...
void SPARKGUI::subscribeToCoreSignals()
{
...
void SPARKGUI::unsubscribeFromCoreSignals()
{
