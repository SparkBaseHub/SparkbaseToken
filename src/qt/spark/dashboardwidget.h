...
#include "qt/spark/txviewholder.h"
...
#include "config/spark-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalSpark = 0;
    qint64 totalZsparks = 0;
    QList<qreal> valuesSparks;
    QList<qreal> valueszSparks;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(SPARKGUI* _window);
    ~DashboardWidget();
