...
#include "qt/spark/forms/ui_coldstakingwidget.h"
#include "qt/spark/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/spark/requestdialog.h"
...
ColdStakingWidget::ColdStakingWidget(SPARKGUI* parent) :
    PWidget(parent),
