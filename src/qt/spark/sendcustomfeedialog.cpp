...
#include "qt/spark/sendcustomfeedialog.h"
#include "qt/spark/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(SPARKGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &SPARKGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
