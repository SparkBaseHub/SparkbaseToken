...
#ifndef SPARK_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define SPARK_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //SPARK_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
