...
#include "qt/spark/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/spark/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(SPARKGUI* _window, QWidget *parent) :
