...
#include "qt/spark/settings/settingsnetworkwidget.h"
#include "qt/spark/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/spark/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SPARKGUI* _window, QWidget *parent) :
