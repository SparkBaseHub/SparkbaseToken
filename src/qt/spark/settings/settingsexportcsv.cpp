...
#include "qt/spark/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(SPARKGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("SPARK_tx_csv_export(*.csv)") : tr("SPARK_addresses_csv_export(*.csv)"),
                                        nullptr);
