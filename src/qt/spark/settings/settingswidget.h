...
#include "qt/spark/settings/settingsbackupwallet.h"
#include "qt/spark/settings/settingsexportcsv.h"
#include "qt/spark/settings/settingsbittoolwidget.h"
#include "qt/spark/settings/settingssignmessagewidgets.h"
#include "qt/spark/settings/settingswalletrepairwidget.h"
#include "qt/spark/settings/settingswalletoptionswidget.h"
#include "qt/spark/settings/settingsmainoptionswidget.h"
#include "qt/spark/settings/settingsdisplayoptionswidget.h"
#include "qt/spark/settings/settingsinformationwidget.h"
#include "qt/spark/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(SPARKGUI* parent);
    ~SettingsWidget();
