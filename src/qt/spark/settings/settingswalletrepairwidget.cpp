...
#include "qt/spark/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/spark/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SPARKGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SPARKGUI::handleRestart()
