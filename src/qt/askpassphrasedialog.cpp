...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            SPARKGUI* window = static_cast<SPARKGUI*>(parentWidget());
...
{
    SPARKGUI* gui = static_cast<SPARKGUI*>(parentWidget());
...
{
    hide();
    static_cast<SPARKGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("%1 will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your SPARKS from being stolen by malware infecting your computer.").arg(PACKAGE_NAME) +
            "<br><br><b>" +
